  ...
  >
    ...
    >
      <DialogTrigger as-child>
        <Button variant="info"> <Plus /> Add Expense </Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle
          ...
          /></DialogTitle>
          <DialogDescription>
            <h3 class="text-primary mb-2 text-lg font-semibold">Add Expense</h3>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            :disabled="isCreateExpenseLoading || isUploadReceiptLoading"
          >
            <Loader2
              v-if="isCreateExpenseLoading || isUploadReceiptLoading"
              class="mr-2 h-4 w-4 animate-spin"
            />
            <template v-if="isUploadReceiptLoading"
              >Uploading receipt...</template
            >
            <template v-else-if="isCreateExpenseLoading"
              >Creating expense record...</template
            >
...
const {
  ...
  isLoading: isCreateExpenseLoading,
...
async function handleCreateUploadReceipt(values: any) {
  try {
    ...
    await createExpense(`/client-lots/${clientLotId}/expenses`, {
      method: "POST",
      data: body,
    });
